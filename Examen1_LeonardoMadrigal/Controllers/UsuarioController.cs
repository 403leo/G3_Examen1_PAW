...
namespace Examen1_LeonardoMadrigal.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(Examen1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Nombre,Correo,Telefono,Password,Rol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Nombre,Correo,Telefono,Password,Rol")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
